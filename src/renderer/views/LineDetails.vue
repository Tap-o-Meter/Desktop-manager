<template>
  <div class="Line-details d-flex flex-column align-center">
          ...
          <v-row>
            <v-avatar color="lightgray" size="120" tile>
              <v-img
                ...
                :src="
                  beer.image !== null
                    ? 'http://beer-control.local:3000/getImage/' + beer.image
            ...
            <v-col cols="7">
              ...
              >
                <p class="header-3-alt thin white--text">
                  {{ beer.name }}
                </p>
              </router-link>
          ...
          <v-card elevation="0" class="px-2">
            ...
            >
              <template v-slot:item="{ item }">
                <tr :class="getClass(item.concept)">
                  <td
...
export default {
  ...
  data() {
    return {
      ...
      historyHeaders: [
        ...
        { text: "Estilo", value: "style", width: "65", sortable: false },
  ...
  beforeMount: function() {
    ...
    console.log(this.line.idKeg);
    this.sales = JSON.parse(
      JSON.stringify(
        this.getLineSales(this.line.idKeg),
        ["workerId", "concept", "qty"],
        4
      )
    );
  },
